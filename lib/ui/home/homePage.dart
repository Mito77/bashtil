...
class _homePageViewState extends BaseState<homePageWidget>
        ...
        child: Column(
          ...
          children: [
            ...
            CustomText(
              ...
              customTextStyle: boldTextStyle(28.sp, blackColor.withOpacity(.6)),
            ),
          ],
        ),
      ),
  ...
  Widget get Button => Positioned(
    bottom: 0,
    left: 0,
    right: 0, // Optional: You can adjust the left and right values for horizontal positioning.
    child: Column(
      mainAxisAlignment: MainAxisAlignment.center,
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
            ...
            children: [
              Container(
                ...
                child: CustomButton(
                  ...
                  buttonColor: i == 0 ? buttonColor : whiteColor,
                  onTap: i==0?() {
              ...
              SizedBox(height: 10.0, width: double.infinity), // Add space between containers.
            ],
          ),
      ],
    ),
